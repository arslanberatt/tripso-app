/**
 * Profil + tercihler hook'u (Profile sekmesi + Kişiselleştirme sihirbazı).
 *
 * Profil, kişiselleştirme sihirbazının yazdığı `profile-store` üzerinden okunur.
